...
set_svf ./outputs/Bit_stream_formality.svf

# 1. Load the RTL design (container "r")
read_verilog -container r -libname WORK -01 { ./rtl/Bit_Stream.v }
set_top r:/WORK/Bit_Stream

# 2. Load the synthesized netlist (container "i")
read_verilog -container i -libname WORK -01 { ./outputs/Bit_stream_synth.v }
